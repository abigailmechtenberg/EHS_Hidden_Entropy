...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    figname1 = strcat('FigureGBoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Generator','.pdf');
    ...
    for PredictionHorizon=1:8 % predictions were grouped to easily see subplot
        ...
        load(filename); % load a specific file 
        a(PredictionHorizon) = subplot(2,4,PredictionHorizon); % subplot for first 8    
        boxplot_month(1,10,'Vehicle Charges', 'kWh', squeeze(VehicleBatteryCharges(Battery,:,:)))
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB1BoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB2BoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB3BoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB4BoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB5BoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB6BoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB7BoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB8BoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB9BoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB10BoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for PredictionHorizon=9:16
        ...
        boxplot_month(1,10,'Fuel Usage','Liters',FuelUsage)  
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname3 = strcat('FigureFigureGBoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Generator','.pdf');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname5 = strcat('FigureGBoxPlotMonth','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Generator','.pdf');
