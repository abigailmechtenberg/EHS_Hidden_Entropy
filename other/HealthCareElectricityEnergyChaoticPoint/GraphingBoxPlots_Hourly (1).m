...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for PredictionHorizon=1:8 % predictions were grouped to easily see subplot
        ...
        a(PredictionHorizon) = subplot(2,8,PredictionHorizon); % subplot for first 8    
    ...
    figname1 = strcat('FigureGBoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Generator','.pdf');
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB1BoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB2BoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB3BoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB4BoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB5BoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB6BoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB7BoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB8BoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB9BoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname2 = strcat('FigureB10BoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Battery',num2str(Battery),'.pdf');
    saveas(fig,figname2,'pdf')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname3 = strcat('FigureFigureGBoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Generator','.pdf');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fig = gcf;
        ...
        fig.PaperPosition = [0 0 15 12];
        fig.PaperOrientation = 'landscape';
    figname5 = strcat('FigureGBoxPlotHour','Rand',num2str(uncertainty),'Horizon',num2str(PredictionHorizon),'Generator','.pdf');
