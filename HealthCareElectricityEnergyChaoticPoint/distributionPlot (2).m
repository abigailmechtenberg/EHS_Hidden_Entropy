...
%
% DISTRIBUTIONPLOT creates violin statistical plots for convenient visualization of 
% multiple distributions: here monthly distribution plots and hourly distribution plots
%
...
%
% created by: Jonas Dorn; jonas.dorn@gmail.com and Abigail Mechtenberg: amechten@gmail.com
% DATE: 08-Jul-2008
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
