function handles = distributionPlot2(varargin)
%DISTRIBUTIONPLOT plots distributions similar to boxplot
%
% SYNOPSIS: handles = distributionPlot2(data,distWidth,showMM,xNames,histOpt,divFactor,invert)
%           handles = distributionPlot2(ah,...)
%
